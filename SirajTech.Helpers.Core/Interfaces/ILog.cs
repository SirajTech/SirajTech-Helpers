...
namespace SirajTech.Helpers.Core
{
    ...
    public interface ILog
    {
        ...
        /// </summary>
        /// <param name="message">The message.</param>
        /// <param name="exception">The Exception if exist </param>
        /// <param name="formatting">The formatting.</param>
        void Error(string message, Exception exception = null, params object[] formatting);
        ...
        /// <param name="exception">The Exception if exist </param>
        /// <param name="formatting">The formatting.</param>
        void Fatal(string message, Exception exception = null, params object[] formatting);
